...
<div class="message"
    :class ="{'message-ok': authResult, 'message-error': authResult===false , 'input-ivan': inputIvan===true}"
    >{{messageResult}}
</div>
<div v-if="authResult">
        ...
        props: {
            ...
            computed: {
                ...
                messageResult() {
                    ...
                    if(this.inputIvan === true) return "Input error"
                ...
                onLogin() {
                    ...
                    if(user){
                        ...
                        this.authResult= false
                          this.inputIvan=null
                    const userIvan = this.loginsList.find(item=>item.log=="Ivan")
